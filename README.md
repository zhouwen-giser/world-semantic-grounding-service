...
The v0.2.3 advanced-history work item adds opt-in GSAP road association, temporal events, metric ranking, and trusted historical follow-ups through the existing GOWM Gateway. It does not change release versions or authorize current recommendations, routes, or device execution. See [advanced historical analysis](docs/advanced-historical-analysis.md) for contracts, configuration, data prerequisites, and offline/live verification.
